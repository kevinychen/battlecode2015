...
public class RobotPlayer {
    ...
    static final int NUM_MINER_FACTORIES = 3;
    static final int NUM_HELIPADS = 4;
    static final int NUM_LABS = 5;
        ...
        while(true) {
            try {
                ...
                if (myType == RobotType.HQ) {
                    ...
                    rc.broadcast(NUM_MINER_FACTORIES, numMinerFactories);
                    ...
                    numMiners = rc.readBroadcast(NUM_MINERS);
                    numMinerFactories = rc.readBroadcast(NUM_MINER_FACTORIES);
    ...
    static void runMinerFactory() throws Exception {
        if (numBeavers + numMiners < MAX_WORKERS)
