...
public class RobotPlayer {
    ...
    static final int NUM_FACTORIES = 3;
        ...
        while(true) {
            ...
            try {
                ...
                if (myType == RobotType.HQ) {
                    ...
                    numFactories = rc.readBroadcast(NUM_FACTORIES);
    ...
    static void runBeaver() throws Exception {
        ...
        if ((numFactories <= 1 && (numFactories == 0 || roundNum > 200)))
    ...
    static void runFactory() throws Exception {
        trySpawn(RobotType.TANK);
    }

    static void runTank() throws Exception {
        attackSomething();
